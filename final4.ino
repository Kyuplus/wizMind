...
int state =0;  //state =0 -->stop     state =1 -->turn    state =2 -->move
int a; //accelator
...
void Mindwave_FFT() 
{
  ...
  norm_factor=((double)(avg_factor-Min_factor)/(double)(Max_factor-Min_factor))*100;//normalization
